...
public class passJoker extends JFrame {
	...
	private String pass = "letales";
	private String pass1 = "cambios";
	private String pass2 = "juego";
	private String pass3 = "castigo";
	/**
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					passJoker frame = new passJoker(args[0]);
